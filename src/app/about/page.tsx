...
export default function Home() {
  return (
    <main className="bg-primary text-primary max-w-[1920px] m-auto relative">
      ...
      <section className="px-6 py-4 relative  md:mb-8  md:mx-[24px] md:rounded-b-[18px]  xl:rounded-b-[36px] xl:px-16 xl:py-16 bg-secondary xl:mx-[62px] xl:mb-12 md:drop-shadow-lg ">
        ...
        <section className="flex flex-wrap-reverse lg:grid lg:grid-cols-2 lg:place-content-end gap-8">
          ...
          <section>
            <p className="max-w-[45ch] lg:max-w-full font-roboto font-semibold text-lg">
              ...
              long-term obsession, and I can&lsquo;t get enough of those isekai
              adventures), or getting lost in a psychological thriller like{" "}
              <em>The Silent Patient</em>.
            </p>
            <p className="max-w-[45ch lg:max-w-full font-roboto font-semibold text-lg">
              I&lsquo;m also a big fan of manhwa, which keeps my creative juices
              flowing and gives me fresh inspiration for my design projects. So,
              whether I&lsquo;m working on a new interface or just chilling with
              some manga, I&lsquo;m always on the lookout for the next great
